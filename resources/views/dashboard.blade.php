                ...
                <table class="table">
                  <tbody>
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('theme/assets/img/flags/US.png')}}">
                        </div>
                      </td>
                      <td>USA</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('theme/assets/img/flags/DE.png')}}">
                        </div>
                      </td>
                      <td>Germany</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('theme/assets/img/flags/AU.png')}}">
                        </div>
                      </td>
                      <td>Australia</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('theme/assets/img/flags/GB.png')}}">
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('theme/assets/img/flags/RO.png')}}">
                        </div>
                      </td>
                      <td>Romania</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('theme/assets/img/flags/BR.png')}}">
                        </div>
                      </td>
                      <td>Brasil</td>
                      <td class="text-right">
            ...
            <table class="table">
              <tbody>
                <tr>
                  ...
                  <td class="img-row">
                    <div class="img-wrapper">
                      <img src="{{asset('theme/assets/img/faces/ayo-ogunseinde-2.jpg')}}" class="img-raised" />
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td class="img-row">
                    <div class="img-wrapper">
                      <img src="{{asset('theme/assets/img/faces/erik-lucatero-2.jpg')}}" class="img-raised" />
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td class="img-row">
                    <div class="img-wrapper">
                      <img src="{{asset('theme/assets/img/faces/kaci-baum-2.jpg')}}" class="img-raised" />
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td class="img-row">
                    <div class="img-wrapper">
                      <img src="{{asset('theme/assets/img/faces/joe-gardner-2.jpg')}}" class="img-raised" />
                    </div>
                  </td>
